...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    if (widget.user.introChoice != null) {
      currentPage = three;
      currentTab = 2;
    } else {
      currentPage = one;
  ...
  /* _getProfileImage() async {
    ...
    .getDocuments();
    qSnapProfileImage.documents.forEach((doc) {
      print(doc.data["profileImage"]);
      if(doc.data["profileImage"] != null){
        widget.user.profileImage = doc.data["profileImage"];
      }
                                                                      ...
                                                                      children: <
                                                                        ...
                                                                        new Text(
                                                                            document.data[
                                                                                "title"],
                                                                            style:
                                                                                ServiceProvider.instance.styles.cardTitle()),
                                                                        Icon(
                                                                          Icons
                                                                              .star,
                                                                          color: going && starred == snapshot
                                                                              ? UIData.pink
                                                                              : Colors.white,
                                                                          size:
                                                                              20,
