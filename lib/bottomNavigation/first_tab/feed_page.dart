...
class PageOne extends StatefulWidget {
  PageOne({Key key, this.auth, this.onSignOut, this.user, this.eventList, this.onRefresh, }) : super(key: key);
  final BaseAuth auth;
  final VoidCallback onSignOut;
  final User user;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        onPressed: () {
          ...
          Navigator.push(
            ...
            MaterialPageRoute(builder: (context) =>
                StatefullNew(user: widget.user.userName)),);
        },
      ...
      appBar: new AppBar(
          ...
          Align(
            ...
            child: Padding(
              ...
              child: IconButton(
                ...
                icon: Image.asset(
                  'lib/assets/images/filter_icon.png', scale: 10,),
                onPressed: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
        ...
        title: Image.asset(
          'lib/assets/images/logo_tekst.png', fit: BoxFit.contain, scale: 8,),
        centerTitle: true,
                          ...
                          return Column(
                            children: <Widget>[
                              ...
                              GestureDetector(
                                ...
                                child: Column(
                                  children: <Widget>[
                                    tap == true && tapped != null &&
                                        tapped == position ?
                                    SizedBox(
                                      height: 310,
                                      width: ServiceProvider.instance
                                          .screenService
